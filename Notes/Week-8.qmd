...
can we make the bias while keeping the variance manageable?
...
results in an optimal RMSE of order $N^{-2/(2+P)}$ (assuming that $\mu(x)$ is
twice-continuously differentiable).

:::{.myexercise data-latex="[Power Analysis]"}

Supposing that the RMSE scales like $N^{-2/(2+P)}$, how large must $N$ be in
